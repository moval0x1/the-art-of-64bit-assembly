...
.code
    ...
    asmMain PROC
        ...
        ; Later chapters in Ao64A will describe how to check for errors from the user.
        lea rcx, prompt1
        call printf
        ...
        lea rcx, input
        call atoi
        and rax, 0ffh   ; Only keep LO 8 bits, only al filled
        mov intValue, rax
        ...
        ; integer here, because C++ %d format specifier expects a 32bit integer)
        ; HO 32 bits of RDX get ignored by C++.
        mov rdx, intValue
        not rdx
        add rdx, 1
        lea rcx, fmtStr4
        ...
        ; previous one before this returns to its caller
        add rsp, 56
        ret
    asmMain ENDP
END
